...
- **type**: [strictish string](#definitionsstrictishstring)
- **required**: `false`
...
- **type**: Array of [strictish string](#definitionsstrictishstring)
- **required**: `false`
    ...
    1. <details>
          ...
          <ul>
            ...
            <li>
              <code>value</code>:
              <ul>
                <li><strong>type</strong>: <a href="#definitionsstrictishstring"><code>strictish string</code></a>.</li>
                <li><strong>required</strong>: <code>true</code></li>
...
- **type**: [strictish string](#definitionsstrictishstring) or `integer`
- **required**: `false`
...
- **type**: [strictish string](#definitionsstrictishstring) or `number`
- **required**: `false`
